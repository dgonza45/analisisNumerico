...
if metodo_seleccionado_capitulo1 == 'Bisección':
    ...
    interval_a = st.number_input('Ingrese el punto A del intervalo', value=0, step=0.1)
    interval_b = st.number_input('Ingrese el punto B del intervalo', value=0, step=0.1)
